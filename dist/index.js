...
/***/ function(module, exports, __webpack_require__) {
	...
	var _validates = __webpack_require__(5);
	
	var _validates2 = _interopRequireDefault(_validates);
	...
	function install(Vue, options) {
		Vue.directive('ms-form', {
			...
			bind: function bind() {
				var vm = this.vm;
				var el = this.el;
				var formName = el.getAttribute("name");
		...
		Vue.directive('ms-required', function (options) {
			...
			var _watchKey = _util2.default.getWatchKey(Vue, this, options);
			var _fieldKey = _util2.default.getFieldKey(this);
			var vmScope = this._scope ? this._scope : vm;
	
			_util2.default.formFieldInit(vmScope, _fieldKey);
			vmScope.$watch(_watchKey, function (newVal, oldVal) {
				var result = _validates2.default.required(newVal);
				_util2.default.updateValid(vmScope, _fieldKey, "required", result, el, oldVal);
			}, {
				immediate: true
			});
		});
		...
		Vue.directive('ms-max', function (options) {
			...
			_util2.default.formFieldInit(vmScope, _fieldKey);
			vmScope.$watch(_watchKey, function (newVal, oldVal) {
				var result = _validates2.default.max(newVal, options.max);
				_util2.default.updateValid(vmScope, _fieldKey, "max", result, el, true);
			}, {
				immediate: true
			});
		});
		...
		Vue.directive('ms-min', function (options) {
			...
			_util2.default.formFieldInit(vmScope, _fieldKey);
			vmScope.$watch(_watchKey, function (newVal, oldVal) {
				var result = _validates2.default.min(newVal, options.min);
				_util2.default.updateValid(vmScope, _fieldKey, "min", result, el, true);
			}, {
				immediate: true
			});
		});
		...
		Vue.directive('ms-max-length', function (options) {
			...
			_util2.default.formFieldInit(vmScope, _fieldKey);
			vmScope.$watch(_watchKey, function (newVal, oldVal) {
				var result = _validates2.default.maxLength(newVal, options.maxLength);
				_util2.default.updateValid(vmScope, _fieldKey, "maxLength", result, el, true);
			}, {
				immediate: true
			});
		});
		...
		Vue.directive('ms-min-length', function (options) {
			...
			_util2.default.formFieldInit(vmScope, _fieldKey);
			vmScope.$watch(_watchKey, function (newVal, oldVal) {
				var result = _validates2.default.minLength(newVal, options.minLength);
				_util2.default.updateValid(vmScope, _fieldKey, "minLength", result, el, true);
			}, {
				immediate: true
			});
		});
		...
		Vue.directive('ms-pattern', function (options) {
			...
			_util2.default.formFieldInit(vmScope, _fieldKey);
			vmScope.$watch(_watchKey, function (newVal, oldVal) {
				var result = _validates2.default.pattern(newVal, options.pattern);
				_util2.default.updateValid(vmScope, _fieldKey, "pattern", result, el, true);
			}, {
				immediate: true
			});
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getWatchKey(Vue, obj, options) {
		var el = obj.el;
		var expression = el.getAttribute((Vue.config.prefix ? Vue.config.prefix : 'v-') + 'model');
		if (expression) {
			return expression;
		} else {
	...
	function getFieldKey(obj) {
		var vm = obj.vm;
		var el = obj.el;
		var filedName = el.getAttribute("name");
		var formName = vm.$get("formName");
		if (formName) {
	...
	function updateValid(_vm, _key, _item, _value, _el, _operateElement) {
		...
		var valid = true;
		for (var item in _vm.$get(_key + ".$error")) {
		...
		if (_operateElement) {
			if (valid) {
				_vue2.default.util.removeClass(_el, "invalid");
				_vue2.default.util.addClass(_el, "valid");
			} else {
				_vue2.default.util.removeClass(_el, "valid");
				_vue2.default.util.addClass(_el, "invalid");
			}
		}
	}
...
/***/ function(module, exports) {
	...
	/**
	 * Created by fengxiaotx on 2016/3/26.
	 */
	'use strict';
	
	module.exports = {
	    validateItems: ["required", "max"]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function required(val) {
	  if (Array.isArray(val)) {
	    ...
	    return true;
	  } else if (val !== null && (typeof val === 'undefined' ? 'undefined' : (0, _typeof3.default)(val)) === 'object') {
